...
<html lang="en">
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href=""> <img src="{{ asset('icons/diamond.png')}}" width="25px" height="25px"> Hideen Gems</a>
            <!-- Sidebar Toggle-->
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Hidden Gems 2023</div>
                        </div>
                    </div>
                </footer>
            </div>
        ...
        <script src="{{ asset('mainLayout/js/scripts.js')}}"></script>
    </body>
</html>